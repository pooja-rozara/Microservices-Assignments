package com.capgemini.price.controller;
...
import com.capgemini.price.dao.PriceDao;
...
public class Controller {
	...
	public Price getCatalog(@PathVariable(value = "id") int id) {
	...
	public Price updateCatalog(@RequestBody Price mr) {
		return repo.save(mr);
	}
	@PostMapping(value= "/addPrice")
	public Price addCatalog(@RequestBody Price mr) {
		return repo.save(mr);
	}
